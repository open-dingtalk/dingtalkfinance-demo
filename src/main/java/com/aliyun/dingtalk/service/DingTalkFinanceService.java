...
/**
 * @author shiyan
 * @version $Id: DingTalkFinanceService.java, v 0.1 2021-10-20 下午8:21 shiyan Exp $$
 */
public interface DingTalkFinanceService {
    /**
     * 获取token
     *
     * @return access-token
     ...
     * https://developers.dingtalk.com/document/app/create-a-badge-user-instance?spm=a2q3p.21071111.0.0.68331cfa2MUIoT
     * </p>
     *
     ...
     * <p>
     * 更新用户钉工牌码的相关信息
     * https://developers.dingtalk.com/document/app/update-dingtalk-user-instance?spm=a2q3p.21071111.0.0.68331cfa2MUIoT
     * </p>
     *
     ...
     * @throws Exception
     */
    DecodeBadgeCodeResponse decodeBadgeCode(String payCode, String requestId) throws Exception;
     ...
     * @throws Exception
     */
    String notifyBadgeCodePayResult(String payCode, String corpId, String userId, String gmtTradeCreate, String gmtTradeFinish,
     ...
     * @throws Exception
     */
    String notifyBadgeCodeRefundResult(String corpId, String userId, String tradeNo, String refundOrderNo, String remark, String refundAmount,
     ...
     * @throws Exception
     */
    SaveBadgeCodeCorpInstanceResponseBody saveCorpPayCode(String corpId, String codeIdentity, String status, Map<String, String> extInfo) throws Exception;
}